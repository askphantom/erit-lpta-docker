...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["subscriptions-subscription-module"], {
  ...
  /***/
  function srcAppPageSubscriptionsSubscriptionPageSubscriptionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SubscriptionComponent = /*#__PURE__*/function () {
      function SubscriptionComponent(authService, generalService) {
    ...
    SubscriptionComponent.ɵfac = function SubscriptionComponent_Factory(t) {
      return new (t || SubscriptionComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core__WEBPACK_IMPORTED_MODULE_1__["GeneralService"]));
    };
    ...
    SubscriptionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 4,
      consts: [[1, "flex", "fill-available-w", "bg-grey"], [1, "fill-available-w", "pb-3"], [1, "d-flex", "justify-content-between", "pull-down", "align-box", "bg-grey"], [1, "flex", "pt-2", "pb-2"], [1, "text-black", "mb-0"], [1, "font-weight-light"], [1, "float-right", "side-box", "flex", "text-gray"], [1, "circle"], [1, "icon", "bordered-box", 3, "routerLink"], [1, "badge", "shift-left", "badge-danger", "position-absolute", "rounded-circle", "pulsating-circle"], [1, "px-4", "position-relative"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SubscriptionComponent, [{
        ...
        args: [{
          ...
          styleUrls: ["../../page/page.component.scss", "./subscription.component.scss"]
        }]
      }], function () {
        return [{
          type: src_app_core__WEBPACK_IMPORTED_MODULE_1__["AuthService"]
        }, {
          type: src_app_core__WEBPACK_IMPORTED_MODULE_1__["GeneralService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppPageSubscriptionsSubscriptionRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _view_present_subscription_view_present_subscription_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./view-present-subscription/view-present-subscription.component */
    "./src/app/@page/subscriptions/view-present-subscription/view-present-subscription.component.ts");
    /* harmony import */


    var _view_single_subscription_view_single_subscription_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./view-single-subscription/view-single-subscription.component */
    "./src/app/@page/subscriptions/view-single-subscription/view-single-subscription.component.ts");
    /* harmony import */


    var _subscription_page_subscription_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./subscription-page/subscription.component */
    "./src/app/@page/subscriptions/subscription-page/subscription.component.ts");
    /* harmony import */
    ...
    var _view_all_packages_view_all_packages_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./view-all-packages/view-all-packages.component */
    ...
    var routes = [{
      ...
      children: [{
        ...
        path: "packages",
        component: _view_all_packages_view_all_packages_component__WEBPACK_IMPORTED_MODULE_4__["ViewAllPackagesComponent"]
      }, {
        ...
        path: "package/:type",
        component: _view_single_subscription_view_single_subscription_component__WEBPACK_IMPORTED_MODULE_1__["ViewSingleSubscriptionComponent"]
      }]
    }];

    var SubscriptionRoutingModule = /*#__PURE__*/_createClass(function SubscriptionRoutingModule() {
      _classCallCheck(this, SubscriptionRoutingModule);
    });

    SubscriptionRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({
      type: SubscriptionRoutingModule
    });
    SubscriptionRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](SubscriptionRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](SubscriptionRoutingModule, [{
    ...
    var routedComponents = [_view_all_packages_view_all_packages_component__WEBPACK_IMPORTED_MODULE_4__["ViewAllPackagesComponent"], _view_present_subscription_view_present_subscription_component__WEBPACK_IMPORTED_MODULE_0__["ViewPresentSubscriptionComponent"], _view_single_subscription_view_single_subscription_component__WEBPACK_IMPORTED_MODULE_1__["ViewSingleSubscriptionComponent"], _subscription_page_subscription_component__WEBPACK_IMPORTED_MODULE_2__["SubscriptionComponent"]];
    /***/
  },
  ...
  /***/
  function srcAppPageSubscriptionsSubscriptionModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_vg_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/vg-menu */
    "./src/app/vg-menu/index.ts");
    /* harmony import */
    ...
    var _view_all_packages_view_all_packages_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./view-all-packages/view-all-packages.component */
    "./src/app/@page/subscriptions/view-all-packages/view-all-packages.component.ts");
    /* harmony import */


    var _view_present_subscription_view_present_subscription_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./view-present-subscription/view-present-subscription.component */
    "./src/app/@page/subscriptions/view-present-subscription/view-present-subscription.component.ts");
    /* harmony import */


    var _view_single_subscription_view_single_subscription_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./view-single-subscription/view-single-subscription.component */
    "./src/app/@page/subscriptions/view-single-subscription/view-single-subscription.component.ts");
    /* harmony import */


    var _subscription_page_subscription_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./subscription-page/subscription.component */
    "./src/app/@page/subscriptions/subscription-page/subscription.component.ts");

    var SubscriptionModule = /*#__PURE__*/_createClass(function SubscriptionModule() {
      _classCallCheck(this, SubscriptionModule);
    });

    SubscriptionModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: SubscriptionModule
    });
    SubscriptionModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function SubscriptionModule_Factory(t) {
        return new (t || SubscriptionModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_vg_menu__WEBPACK_IMPORTED_MODULE_3__["NgxMenuModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialogModule"], _subscription_routing_module__WEBPACK_IMPORTED_MODULE_0__["SubscriptionRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SubscriptionModule, {
        declarations: [_view_all_packages_view_all_packages_component__WEBPACK_IMPORTED_MODULE_6__["ViewAllPackagesComponent"], _view_present_subscription_view_present_subscription_component__WEBPACK_IMPORTED_MODULE_7__["ViewPresentSubscriptionComponent"], _view_single_subscription_view_single_subscription_component__WEBPACK_IMPORTED_MODULE_8__["ViewSingleSubscriptionComponent"], _subscription_page_subscription_component__WEBPACK_IMPORTED_MODULE_9__["SubscriptionComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_vg_menu__WEBPACK_IMPORTED_MODULE_3__["NgxMenuModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialogModule"], _subscription_routing_module__WEBPACK_IMPORTED_MODULE_0__["SubscriptionRoutingModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SubscriptionModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: _toConsumableArray(_subscription_routing_module__WEBPACK_IMPORTED_MODULE_0__["routedComponents"]),
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_vg_menu__WEBPACK_IMPORTED_MODULE_3__["NgxMenuModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialogModule"], _subscription_routing_module__WEBPACK_IMPORTED_MODULE_0__["SubscriptionRoutingModule"]]
        }]
      }], null, null);
    })();
  ...
  /***/
  function srcAppPageSubscriptionsViewAllPackagesViewAllPackagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewAllPackagesComponent", function () {
      return ViewAllPackagesComponent;
    });
    /* harmony import */
    ...
    var src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/@core/plans-subscription.service */
    "./src/app/@core/plans-subscription.service.ts");
    /* harmony import */
    ...
    function ViewAllPackagesComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewAllPackagesComponent_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ViewAllPackagesComponent = /*#__PURE__*/function () {
      function ViewAllPackagesComponent(generalService, toastr, service) {
        _classCallCheck(this, ViewAllPackagesComponent);
      ...
      _createClass(ViewAllPackagesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "getSingleSubscriptionDetails",
        value: function getSingleSubscriptionDetails() {
          var _this = this;

          this.generalService.showLoader(true);
          this.service.getSingleSubscription().subscribe(function (data) {
            _this.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this.singleCount = +data.list["package"].find(function (x) {
                return x._attributes.payment_type.trim().toLowerCase() === "paid";
              }).user_count._text;
            } else {
              _this.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this.generalService.showLoader(false);
        ...
        key: "getMultipleSubscriptionDetails",
        value: function getMultipleSubscriptionDetails() {
          var _this2 = this;

          this.generalService.showLoader(true);
          this.service.getMultiSubscription().subscribe(function (data) {
            _this2.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this2.multiple = data.list["package"].filter(function (m) {
                return m._attributes.payment_type.trim().toLowerCase() === "paid";
              });
            } else {
              _this2.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this2.generalService.showLoader(false);

            _this2.toastr.error("Something went wrong");
          });
        }
      }, {
        key: "getUserSubscriptionStatus",
        value: function getUserSubscriptionStatus() {
          var _this3 = this;

          this.generalService.showLoader(true);
          this.service.getUsersSubscriptionStatus().subscribe(function (data) {
            //  data = this.generalService.xmlToJson(subscribedUser);
            _this3.generalService.showLoader(false);

            if (data.status._text && data.status._text != "Failed") {
              delete data.status;
              delete data.status_message;
              _this3["package"] = _this3.generalService.convertToOneLayerViewModel(data);
            } else {
              _this3.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this3.generalService.showLoader(false);

            _this3.toastr.error("Something went wrong");
          });
        }
      }]);
    ...
    ViewAllPackagesComponent.ɵfac = function ViewAllPackagesComponent_Factory(t) {
      return new (t || ViewAllPackagesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_core__WEBPACK_IMPORTED_MODULE_2__["GeneralService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_4__["PlanSubscriptionService"]));
    };

    ViewAllPackagesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: ViewAllPackagesComponent,
      selectors: [["app-view-all-packages"]],
      decls: 10,
      vars: 3,
      consts: [[1, "card-white"], [1, "card-body", "px-3", "py-4"], [1, "sub-info", "p-3", "d-flex", "justify-content-between"], [1, "d-flex", "flex-column", "justify-content-center"], [1, "text-grey-400", "d-inline", "d-sm-none"], [1, "deep-green"], ["class", "d-flex align-items-center", 4, "ngIf"], ["class", "", 4, "ngIf"], [1, "d-flex", "align-items-center"], [1, "text-green-500", "d-none", "d-sm-inline"], [1, "d-flex", "flex-column", "flex-md-row", "btns"], [1, "btn", "btn-outline-secondary", "ml-2", "p-2", "mb-2", 3, "routerLink"], [1, "btn", "bg-green-300", "bg-success", "p-2", "ml-2", "btn-renew", 3, "routerLink"], [1, ""], [1, "mt-3", "mb-2", "text-black"], [1, "d-flex", "justify-content-center", "flex-row", "flex-wrap"], [1, "sub-box", "single"], [1, "py-2", "px-4"], [1, "d-flex", "justify-content-between", "m-0", "align-items-center", "w-100"], ["width", "14", "height", "11", 1, "svg-icon"], [1, "text-white"], [1, "d-flex", "pb-2"], [1, "btn", "bg-white", "m-auto", 3, "routerLink"], [1, "sub-box", "multi-silver"], [1, "pr-md-4", "pr-0"], [1, "sub-box", "multi-gold"], [1, "sub-box", "multi-platinum"]],
      template: function ViewAllPackagesComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["DecimalPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["TitleCasePipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ViewAllPackagesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
          selector: "app-view-all-packages",
          templateUrl: "./view-all-packages.component.html",
          styleUrls: ["../subscription-page/subscription.component.scss", "./view-all-packages.component.scss"]
        }]
      }], function () {
        return [{
          type: src_app_core__WEBPACK_IMPORTED_MODULE_2__["GeneralService"]
        }, {
          type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]
        }, {
          type: src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_4__["PlanSubscriptionService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppPageSubscriptionsViewPresentSubscriptionViewPresentSubscriptionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewPresentSubscriptionComponent", function () {
      return ViewPresentSubscriptionComponent;
    });
    /* harmony import */
    ...
    var src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/@core/plans-subscription.service */
    "./src/app/@core/plans-subscription.service.ts");
    /* harmony import */
    ...
    function ViewPresentSubscriptionComponent_div_2_h4_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewPresentSubscriptionComponent_div_2_h4_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "h4", 22);
      ...
      if (rf & 2) {
        var ctx_r435 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);
    ...
    function ViewPresentSubscriptionComponent_div_2_div_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewPresentSubscriptionComponent_div_2_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewPresentSubscriptionComponent_div_2_div_25_ng_container_15_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewPresentSubscriptionComponent_div_2_div_25_ng_container_15_div_1_Template_span_click_2_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r444);

          var i_r441 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().index;

          var ctx_r443 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3);

          var _r430 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](4);

          ctx_r443.selectedEmailIndex = i_r441;
          return ctx_r443.openModal(_r430, "confirm-box");
        });
      ...
      if (rf & 2) {
        var email_r440 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", email_r440 ? "x" : " \xA0", "");
      }
    }

    function ViewPresentSubscriptionComponent_div_2_div_25_ng_container_15_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var email_r440 = ctx.$implicit;

        var ctx_r439 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3);
    ...
    function ViewPresentSubscriptionComponent_div_2_div_25_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewPresentSubscriptionComponent_div_2_div_25_Template_i_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r448);

          var ctx_r447 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          var _r432 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](6);

          return ctx_r447.openModal(_r432);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewPresentSubscriptionComponent_div_2_div_25_Template_button_click_16_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r448);

          var ctx_r449 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r449.reload();
        });
      ...
      if (rf & 2) {
        var ctx_r438 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);
    ...
    function ViewPresentSubscriptionComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](17, " Expiration Date: \xA0");
    ...
    function ViewPresentSubscriptionComponent_ng_template_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewPresentSubscriptionComponent_ng_template_3_Template_button_click_6_listener() {
          ...
          return ctx_r450.removeEmail(ctx_r450.selectedEmailIndex);
        });
    ...
    function ViewPresentSubscriptionComponent_ng_template_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function ViewPresentSubscriptionComponent_ng_template_5_Template_textarea_ngModelChange_9_listener($event) {
          ...
          return ctx_r452.emailsInString = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewPresentSubscriptionComponent_ng_template_5_Template_button_click_10_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r453);

          var ctx_r454 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r454.saveMultiEmails(ctx_r454.emailsInString);
        });
    ...
    var ViewPresentSubscriptionComponent = /*#__PURE__*/function () {
      function ViewPresentSubscriptionComponent(generalService, toastr, dialog, service, authService) {
        _classCallCheck(this, ViewPresentSubscriptionComponent);
      ...
      _createClass(ViewPresentSubscriptionComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getUserSubscriptionStatus();
          this.userEmail = this.authService.getUserLocally().email; //  this.emailsInString = this.emails.join(",\n");
        }
      }, {
        key: "getUserSubscriptionStatus",
        value: function getUserSubscriptionStatus() {
          ...
          this.service.getUsersSubscriptionStatus().subscribe(function (data) {
            //data = this.generalService.xmlToJson(subscribedUser);
            _this4.generalService.showLoader(false);

            if (data.status._text && data.status._text != "Failed") {
              delete data.status;
              delete data.status_message;
              _this4["package"] = _this4.generalService.convertToOneLayerViewModel(data);
              _this4["package"].package_name = _this4["package"].package_name.toLowerCase().includes("single") ? "single" : _this4["package"].package_name;

              if (_this4["package"].user_type === "primary" && !_this4["package"].package_name.toLowerCase().includes("single")) {
                _this4.getEmailsOnSubscription();
              }

              if (_this4["package"].package_name.toLowerCase().includes("single")) {
                _this4.getSingleSubscriptionDetails();
              } else {
                _this4.getMultipleSubscriptionDetails();
              }
            } else {
              _this4.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this4.generalService.showLoader(false);
        ...
        value: function getSingleSubscriptionDetails() {
          ...
          this.generalService.showLoader(true);
          this.service.getSingleSubscription().subscribe(function (data) {
            _this5.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this5.subPackage = data.list["package"].find(function (x) {
                return x._attributes.payment_type.trim().toLowerCase() === "paid";
              });
              _this5.subPackage.name._text = _this5.subPackage.name._text.toLowerCase().trim().replace("user", "").trim();
            } else {
              _this5.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this5.generalService.showLoader(false);

            _this5.toastr.error("Something went wrong");
          });
        }
      }, {
        key: "getMultipleSubscriptionDetails",
        value: function getMultipleSubscriptionDetails() {
          ...
          this.generalService.showLoader(true);
          this.service.getMultiSubscription().subscribe(function (data) {
            _this6.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this6.subPackage = data.list["package"].find(function (x) {
                return x.name._text.toLowerCase().trim() === _this6["package"].package_name.toLowerCase().trim();
              });
              _this6.emails.length = +_this6.subPackage.user_count._text;
            } else {
              _this6.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this6.generalService.showLoader(false);
        ...
        key: "saveMultiEmails",
        value: function saveMultiEmails(emails) {
        ...
        value: function reload() {
          ...
          this.generalService.showLoader(true);
          setTimeout(function () {
            _this7.toastr.success("Completed");

            _this7.generalService.showLoader(false);

            location.reload();
          }, 1000);
        }
      }, {
        key: "savEmailsToSubscription",
        value: function savEmailsToSubscription(emails) {
          var _this8 = this;

          this.generalService.showLoader(true);
          this.service.addEmailsToSubscription(emails, this["package"].subscription_id).subscribe(function (data) {
            _this8.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status;
              _this8.emails.length = +_this8.subPackage.user_count._text;

              _this8.toastr.success("Emails have been added to subscription");

              _this8.dialog.closeAll();

              location.reload();
            } else {
              _this8.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this8.generalService.showLoader(false);
        ...
        key: "removeEmail",
        value: function removeEmail(emailIndex) {
          var _this9 = this;

          this.generalService.showLoader(true);
          this.service.deleteEmailFromSubscription(this.emails[emailIndex], this["package"].subscription_id).subscribe(function (data) {
            _this9.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status;

              _this9.toastr.success("".concat(_this9.emails[emailIndex], " has been removed from subscription"));

              _this9.emails.splice(emailIndex, 1);

              _this9.emails.length = +_this9.subPackage.user_count._text;

              _this9.dialog.closeAll();
            } else {
              _this9.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this9.generalService.showLoader(false);

            _this9.toastr.error("Something went wrong");
          });
        }
      }, {
        key: "getEmailsOnSubscription",
        value: function getEmailsOnSubscription() {
          var _this10 = this;

          this.generalService.showLoader(true);
          this.service.getEmailsOnSubscription(this["package"].subscription_id).subscribe(function (data) {
            _this10.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status;
              _this10.emails = data.subscription_users.user.map(function (x) {
                return x.email._text;
              });
            } else {
              _this10.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this10.generalService.showLoader(false);

            _this10.toastr.error("Something went wrong");
          });
        }
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ViewPresentSubscriptionComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_5__["PlanSubscriptionService"]
        }, {
          type: src_app_core__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppPageSubscriptionsViewSingleSubscriptionViewSingleSubscriptionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewSingleSubscriptionComponent", function () {
      return ViewSingleSubscriptionComponent;
    });
    /* harmony import */
    ...
    var src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/@core/plans-subscription.service */
    "./src/app/@core/plans-subscription.service.ts");
    /* harmony import */
    ...
    function ViewSingleSubscriptionComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewSingleSubscriptionComponent_li_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ViewSingleSubscriptionComponent_li_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li");
    ...
    function ViewSingleSubscriptionComponent_div_15_div_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    ...
    function ViewSingleSubscriptionComponent_div_15_div_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    ...
    function ViewSingleSubscriptionComponent_div_15_div_37_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    ...
    function ViewSingleSubscriptionComponent_div_15_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewSingleSubscriptionComponent_div_15_Template_button_click_12_listener($event) {
          ...
          return ctx_r462.subscribeUser($event, 1);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewSingleSubscriptionComponent_div_15_Template_button_click_25_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r463);

          var ctx_r464 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r464.subscribeUser($event, ctx_r464.config.month_count_termly);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ViewSingleSubscriptionComponent_div_15_Template_button_click_38_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r463);

          var ctx_r465 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r465.subscribeUser($event, ctx_r465.config.month_count_session);
        });
    ...
    var ViewSingleSubscriptionComponent = /*#__PURE__*/function () {
      function ViewSingleSubscriptionComponent(route, router, generalService, toastr, authService, service) {
        _classCallCheck(this, ViewSingleSubscriptionComponent);
      ...
      _createClass(ViewSingleSubscriptionComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getType(); // this.toastr.error("data.status_message._text", "Oops");
        }
      }, {
        key: "getType",
        value: function getType() {
          ...
          this.route.paramMap.subscribe(function (param) {
            _this11.type = param.get("type").toLowerCase().trim();

            _this11.getPackageConfig(); // this.pricing = environment.pricing[this.type];

          });
        }
      }, {
        key: "subscribeUser",
        value: function subscribeUser(event, monthCount) {
          var amount = parseInt(event.target.parentElement.parentElement.children[1].children[0].textContent.trim().replace("₦", "").replace(",", ""));
          this.generalService.showLoader(true);
        ...
        value: function getSingleSubscriptionDetails() {
          ...
          this.generalService.showLoader(true);
          this.service.getSingleSubscription().subscribe(function (data) {
            _this12.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this12.single = data.list["package"].find(function (x) {
                return x._attributes.payment_type.trim().toLowerCase() === "paid";
              });

              _this12.getPricing(_this12.single);
            } else {
              _this12.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this12.generalService.showLoader(false);

            _this12.toastr.error("Something went wrong");
          });
        }
      }, {
        key: "getMultipleSubscriptionDetails",
        value: function getMultipleSubscriptionDetails() {
          ...
          this.generalService.showLoader(true);
          this.service.getMultiSubscription().subscribe(function (data) {
            _this13.generalService.showLoader(false);

            if (data.status._text != "Failed") {
              delete data.status._text;
              _this13.multiple = data.list["package"].find(function (x) {
                return x.name._text.toLowerCase().trim() === _this13.type.toLowerCase().trim();
              });

              _this13.getPricing(_this13.multiple, "multi");
            } else {
              _this13.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this13.generalService.showLoader(false);

            _this13.toastr.error("Something went wrong");
          });
        }
      }, {
        ...
        value: function getPackageConfig() {
          ...
          this.generalService.showLoader(true);
          this.service.getPackageConfig().subscribe(function (data) {
            _this14.generalService.showLoader(false);

            if (data.status._text && data.status._text != "Failed") {
              delete data.status;
              delete data.status_message;
              _this14.config = _this14.generalService.convertToOneLayerViewModel(data);

              if (_this14.type === "single") {
                _this14.getSingleSubscriptionDetails();
              } else {
                _this14.getMultipleSubscriptionDetails();
              }
            } else {
              _this14.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this14.generalService.showLoader(false);

            _this14.toastr.error("Something went wrong");
          });
        }
      }, {
        key: "getPricing",
        value: function getPricing(data) {
          var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "single";
          this.pricing.monthly = +data.amount._text * +data.user_count._text * +data.month_count._text;
          this.pricing.termly = +data.amount._text * +data.user_count._text * +this.config.month_count_termly * ((100 - +this.config[type + "_termly_discount"]) / 100);
          this.pricing.sessionly = +data.amount._text * +data.user_count._text * +this.config.month_count_session * ((100 - +this.config[type + "_session_discount"]) / 100);
        }
      }, {
        key: "paymentCallback",
        value: function paymentCallback(response) {
        ...
        key: "payWithPaystack",
        value: function payWithPaystack(amount) {
          var _this15 = this;
          ...
          var handler = PaystackPop.setup({
            ...
            callback: function callback(response) {
              _this15.paymentCallback(response);
            },
            onClose: function onClose() {
              _this15.generalService.showLoader(false);

              _this15.toastr.error("Payment Cancelled");
            }
          });
          handler.openIframe();
        }
      }, {
        key: "createSubscriptionForUser",
        value: function createSubscriptionForUser(amount, monthCount) {
          var _this16 = this;

          this.generalService.showLoader(true);
          var packageId = this.type === "single" ? this.single._attributes.package_id : this.multiple._attributes.package_id;
          this.service.createSubscription({
            package_id: packageId,
            total_cost: amount,
            month_count: monthCount
          }).subscribe(function (data) {
            _this16.generalService.showLoader(false);

            if (data.status._text && data.status._text != "Failed") {
              _this16.orderNumber = data.order_no._text;
              _this16.subscriptionId = data.subscription_id._text;

              _this16.generalService.showLoader(true);

              _this16.payWithPaystack(amount);
            } else {
              _this16.toastr.error(data.status_message._text, "Oops");
            }
          }, function (error) {
            _this16.toastr.error("An Error Occured while subscribing the user");
          });
        }
      }, {
        key: "confirmSubscription",
        value: function confirmSubscription(subscriptionId, orderNumber, paystackStatus) {
          var _this17 = this;

          this.service.confirmSubscriptionOrder({
            subscription_id: subscriptionId,
            order_no: orderNumber,
            tranx_status: paystackStatus
          }).subscribe(function (data) {
            _this17.generalService.showLoader(false);
            ...
            if (data.status._text && data.status._text != "Failed") {
              ...
              _this17.toastr.success("User has been successfully subscribed ", "", {
                timeOut: 10000
              });

              _this17.router.navigate([src_app_config__WEBPACK_IMPORTED_MODULE_0__["appRoutes"].viewPackages]);
            } else {
              _this17.status = {
                worked: false,
                message: data.status_message._text
              ...
              _this17.toastr.error(data.status_message._text, "Oops", {
                timeOut: 12000
              });
            }
          }, function (error) {
            _this17.toastr.error("An Error Occured while subscribing the user");
          });
        }
      }]);
    ...
    ViewSingleSubscriptionComponent.ɵfac = function ViewSingleSubscriptionComponent_Factory(t) {
      return new (t || ViewSingleSubscriptionComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_core__WEBPACK_IMPORTED_MODULE_4__["GeneralService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_core_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_7__["PlanSubscriptionService"]));
    };

    ViewSingleSubscriptionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: ViewSingleSubscriptionComponent,
      selectors: [["app-view-single-subscription"]],
      decls: 16,
      vars: 11,
      consts: [[1, "mw-100", "mb-5"], ["src", "./assets/images/back.png", "alt", "all packages", "width", "36px", "height", "36px", 3, "routerLink"], [1, "d-flex", "flex-wrap"], [3, "class", 4, "ngIf"], [1, "card-white", "info", "p-4", "mb-3", "position-relative"], [4, "ngIf"], ["class", "pricing", 4, "ngIf"], [1, "pricing"], [1, "card-white", "p-3", "mb-3"], [1, "font-weight-medium"], [1, "d-flex", "flex-row", "align-items-center", "py-2"], [1, "text-green-300"], [1, "font-weight-demi-bold"], [1, "d-flex", "flex-row", "align-items-center", "justify-content-between"], [1, "btn", "bg-green-300", "bg-success", "p-2", 3, "click"], [1, "text-grey"]],
      template: function ViewSingleSubscriptionComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLink"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgIf"]],
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_8__["TitleCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["CurrencyPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ViewSingleSubscriptionComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_app_core__WEBPACK_IMPORTED_MODULE_4__["GeneralService"]
        }, {
          type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"]
        }, {
          type: _core_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]
        }, {
          type: src_app_core_plans_subscription_service__WEBPACK_IMPORTED_MODULE_7__["PlanSubscriptionService"]
        }];
      }, null);
    })();
    /***/
...
//# sourceMappingURL=subscriptions-subscription-module-es5.js.map